[Contents](../Contents.md) \| [Previous (1.3 Numbers)](03_Numbers.md) \|
...
The [Unicode Character Database](https://unicode.org/charts) is a reference
...
```python >>> symbols = symbols + 'GOOG' >>> symbols
